    ...
    room: {
        ...
        radiators: {
            ...
            valves: [
                ...
                { id: 64, type: 2, use: 1, fittingsType: 1, connectSide: 2, externalView: 3, preview:'0_0', name: '013G4003 RAX set Хромированный, для подключения терморегулятора справа, запорного клапана слева', basket: [['013G4003', 1]] },
                { id: 65, type: 2, use: 1, fittingsType: 1, connectSide: 1, externalView: 3, preview: '0_0', name: '013G4004 RAX set Хромированный, для подключения терморегулятора слева, запорного клапана справа', basket: [['013G4004', 1]] },
                { id: 66, type: 2, use: 1, fittingsType: 1, connectSide: 2, externalView: 6, preview: '0_0', name: '013G4007 RAX set Холодно-белый (RAL 9016), для подключения терморегулятора справа, запорного клапана слева', basket: [['013G4007', 1]] },
                { id: 67, type: 2, use: 1, fittingsType: 1, connectSide: 1, externalView: 6, preview: '0_0', name: '013G4008 RAX set Холодно-белый (RAL 9016), для подключения терморегулятора слева, запорного клапана справа', basket: [['013G4008', 1]] },
                { id: 68, type: 2, use: 1, fittingsType: 1, connectSide: 1, externalView: 7, preview: '0_0', name: '013G4009 RAX set Нержавеющая сталь, для подключения терморегулятора справа, запорного клапана слева', basket: [['013G4009', 1]] },
                { id: 69, type: 2, use: 1, fittingsType: 1, connectSide: 2, externalView: 7, preview: '0_0', name: '013G4010 RAX set Нержавеющая сталь, для подключения терморегулятора слева, запорного клапана справа', basket: [['013G4010', 1]] },
                    // Полотенцесушитель
                { id: 70, type: 2, use: 2, fittingsType: 1, connectSide: 2, externalView: 3, preview: '0_0', name: 'RTX set, хромированный, для подключения терморегулятора справа, запорного клапана слева: 013G4132', basket: [['013G4132', 1]] },
                { id: 71, type: 2, use: 2, fittingsType: 1, connectSide: 1, externalView: 3, preview: '0_0', name: 'RTX set, хромированный, для подключения терморегулятора слева, запорного клапана справа: 013G4133', basket: [['013G4133', 1]] },
                { id: 72, type: 2, use: 2, fittingsType: 1, connectSide: 2, externalView: 6, preview: '0_0', name: 'RTX set, холодно-белый (RAL 9016), для подключения терморегулятора справа, запорного клапана слева: 013G4136', basket: [['013G4136', 1]] },
                { id: 73, type: 2, use: 2, fittingsType: 1, connectSide: 1, externalView: 6, preview: '0_0', name: 'RTX set, холодно-белый (RAL 9016), для подключения терморегулятора слева, запорного клапана справа: 013G4137', basket: [['013G4137', 1]] },
                { id: 74, type: 2, use: 2, fittingsType: 1, connectSide: 2, externalView: 7, preview: '0_0', name: 'RTX set, нержавеющая сталь, для подключения терморегулятора справа, запорного клапана слева: 013G4138', basket: [['013G4138', 1]] },
                { id: 75, type: 2, use: 2, fittingsType: 1, connectSide: 1, externalView: 7, preview: '0_0', name: 'RTX set, нержавеющая сталь, для подключения терморегулятора слева, запорного клапана справа: 013G4139', basket: [['013G4139', 1]] }
            ]
        },
        floors: {
            control: [
